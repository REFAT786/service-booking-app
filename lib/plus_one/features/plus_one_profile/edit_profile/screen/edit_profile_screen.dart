...
class _EditProfileScreenState extends State<EditProfileScreen> {
  ...
  final List<Map<String, dynamic>> preference = [
    {"name": "Hiking", "isSelected": true},
    {"name": "Dining", "isSelected": true},
    {"name": "Coffee", "isSelected": true},
    {"name": "Reading", "isSelected": true},
    {"name": "Travel", "isSelected": true},
          ...
          actions: <Widget>[
            ...
            TextButton(
              onPressed: () {
                ...
                setState(() {
                  preference.insert(preference.length, {
                    "name": newInterest,
            ...
            Column(
              ...
              children: [
                ...
                Wrap(
                  ...
                  children: preference.map((interest) {
                    return Padding(
